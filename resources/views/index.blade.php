                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <h1 class="display-1 text-white animated slideInRight mb-3">{{ $posts[0]->title }}</h1>
                                    <p class="mb-5 animated slideInRight">{{ $posts[0]->excerpt }}</p>
                                    <a href="../berita/{{ $posts[0]->slug }}" class="btn btn-primary py-3 px-5 animated slideInRight">Explore More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <h1 class="display-1 text-white animated slideInRight mb-3">{{ $posts[1]->title }}</h1>
                                    <p class="mb-5 animated slideInRight">{{ $posts[1]->excerpt }}</p>
                                    <a href="../berita/{{ $posts[1]->slug }}" class="btn btn-primary py-3 px-5 animated slideInRight">Explore More</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 pt-lg-5">
                    <div class="bg-white p-5 mt-lg-5">
                        ...
                        <p class="mb-4 wow fadeIn" data-wow-delay="0.4s">UPTD Pengelolaan Prasarana Perhubungan Pelabuhan Laut mempunyai tugas pokok menyelenggarakan sebagian kegiatan teknis operasional di bidang Pengelolaan Prasarana Perhubungan Pelabuhan Laut, meliputi operasi pelabuhan laut dan fasilitas pelabuhan laut, serta pelaksanaan tugas pokok dan fungsi UPTD Pengelolaan Pengelolaan Prasarana Perhubungan Pelabuhan Laut.</p>
                        {{-- <div class="row g-5 pt-2 mb-5"> --}}
                        <div class="row">
                            <p style="text-align: justify;">Dalam menyelenggarakan tugas pokok, UPTD Pengelolaan Prasarana Perhubungan Pelabuhan Laut mempunyai fungsi:</p>
                            <ol type="a">
                                <li>penyelenggaraan penyusunan bahan kebijakan teknis operasional Pengelolaan Prasarana Perhubungan Pelabuhan Laut;</li> 
                                <li>penyelenggaraan Pengelolaan Prasarana Perhubungan Pelabuhan Laut meliputi operasi pelabuhan laut dan fasilitas pelabuhan laut;</li>
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <img class="d-flex justify-content-center img-fluid w-50" style="margin-left: 25%" src="img/pa_kadis1.jpg" alt="">
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex">
                        ...
                        <a class="btn btn-lg-square btn-primary me-2" href="https://www.instagram.com/kang_kos/"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-lg-square btn-primary me-2" href="https://www.youtube.com/@dishubjabar"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </div>
            {{-- <div class="row g-4">
        ...
        <div class="container pt-5">
            <div class="row gy-5 gx-0">
                <div class="col-lg-6 pe-lg-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p class="text-white mb-5">SIKOPPEL adalah Sistem Informasi Konsultasi Pengelolaan Pelabuhan Laut, dimana di sistem informasi ini para pengguna dapat mengakses fitur utama yaitu Konsultasi langsung, Mengakses berita terbaru, Perizinan, dan Data dan Informasi</p>
                    ...
                    <div class="bg-white p-5">
                        <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
                            <div class="testimonial-item">
                                ...
                                <p class="fs-5 mb-4">Dengan adanya SIKOPPEL diharapkan dapat mewujudkan pelayanan prima kepada masyarakat dalam arti pelayanan yang cepat, tepat, adil dan akuntabel, merupakan harapan bagi setiap institusi pelayanan publik.</p>
