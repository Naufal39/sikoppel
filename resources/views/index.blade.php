        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/pelabuhan1.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/pelabuhan2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <img class="img-fluid w-100" src="img/luffy.png" alt="">
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-6 mb-3">Monkey D Luffy</h1>
                    <p class="mb-1">Captain</p>
                    <p class="mb-5">East Blue</p>
        ...
        <div class="container pt-5">
            <div class="row gy-5 gx-0">
                <div class="col-lg-6 pe-lg-5 wow fadeIn" data-wow-delay="0.3s">
                    <h1 class="display-6 text-white mb-4">About Our Services!</h1>
