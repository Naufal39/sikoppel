    ...
    <div class="col-lg-8">
        <form method="POST" action="../../dashboard/berita" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3" style="color: black">
                ...
                <input style="color: black" type="text" class="form-control @error('title') is-invalid @enderror"
                    id="title" placeholder="Judul Berita/Publikasi" name="title" required autofocus
                    value="{{ old('title') }}">
                @error('title')
