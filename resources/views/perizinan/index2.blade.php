...
@section('isihalaman')
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">STANDAR USAHA PERAWATAN DAN PERBAIKAN KAPAL</h4>
                            <a class="btn btn-light px-3" data-bs-toggle="modal" data-bs-target="#usahaPerbaikanKapal">Read
                                More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">STANDAR USAHA PERANTARA JUAL BELI ATAU SEWA KAPAL</h4>
                            <a class="btn btn-light px-3" data-bs-toggle="modal" data-bs-target="#usahaPerantara">Read
                                More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <dd class="col-sm-9">
                            ...
                            <ol type="a">
                                <li style="margin-bottom: 0%">Memiliki tenaga ahli
                                    ...
                                    Tally Mandiri, sebagai berikut:
                                    <ul>
                                        <li>Tenaga ahli Warga Negara Indonesia: sekurang-kurangnya 1 (satu) orang S-1
                                            (sarjana strata satu) Teknik Perkapalan atau Teknik Sistem Perkapalan yang
                                            sederajat dengan pengalaman kerja sekurang-kurangnya 5 (lima) tahun;</li>
                                        <li>Sekurang-kurangnya 1 (satu) orang tenaga ahli mesin/ mesin kapal/ kelistrikan
                                            kapal berijazah D-III (Diploma tiga) atau yang sederajat dengan pengalaman kerja
                                            sekurang-kurangnya 5 (lima) tahun; dan</li>
                                        <li>Sekurang-kurangnya 1 (satu) orang tenaga ahli pengelasan dengan sertifikat
                                            khusus dengan pengalaman kerja sekurang-kurangnya 5 (lima) tahun.</li>
                                    </ul>
                                </li>
                                <li style="margin-bottom: 0%">Memiliki dan/atau menguasai peralatan dan/atau perlengkapan
                                    Perawatan dan Perbaikan Kapal sesuai dengan kebutuhan kegiatannya sesuai dengan standar
                                    dan ketentuan yang berlaku;</li>
                                <li style="margin-bottom: 0%">Memiliki dan/atau menguasai peralatan dan/atau perlengkapan
                                    keselamatan kerja sesuai dengan standar;</li>
                                <li style="margin-bottom: 0%">Peralatan Perawatan dan Perbaikan Kapal sebagaimana yang
                                ...
                                <li>Surat rekomendasi dari penyelenggara pelabuhan setempat tentang keseimbangan penyediaan
                                    dan permintaan usaha Perawatan dan Perbaikan Kapal berdasarkan jumlah kunjungan kapal
                                    yang berkegiatan di pelabuhan setempat</li>
                                </li>
                    ...
                    <a href="dokumen/PERIZINAN STANDAR USAHA PERAWATAN DAN PERBAIKAN KAPAL.pdf"><button type="button"
                            class="btn btn-primary"><i class="bi bi-filetype-pdf"></i>DOWNLOAD PDF</button></a>
    ...
    <div class="modal fade" id="usahaPerantara" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">C. STANDAR USAHA PERANTARA JUAL BELI ATAU SEWA KAPAL
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <dl class="row" style="color: darkslategray;">
                        ...
                        <dd class="col-sm-9">
                            ...
                            <ol type="a">
                                <li style="margin-bottom: 0%">Tenaga ahli Warga Negara Indonesia yaitu tenaga ahli
                                    ...
                                    atau bidang pelayaran;</li>
                                <li style="margin-bottom: 0%">Tenaga ahli sebagaimana disebutkan dalam ayat 1 (satu)
                                ...
                                <li style="margin-bottom: 0%">Surat rekomendasi dari penyelenggara pelabuhan setempat
                                    tentang keseimbangan penyediaan dan permintaan usaha Perawatan dan Perbaikan Kapal
                                    berdasarkan jumlah kunjungan kapal yang berkegiatan di pelabuhan setempat;</li>
                                <li style="margin-bottom: 0%">Memiliki atau menguasai kendaraan operasional minimal roda 4
                                    (empat) yang dibuktikan dengan bukti. kepemilikan atau sewa yang sah;</li>
                                <li style="margin-bottom: 0%">Memiliki sistem peralatan perangkat lunak dan keras serta
                    ...
                    <a href="dokumen/PERIZINAN USAHA PERANTARA JUAL BELI ATAU SEWA KAPAL.pdf"><button type="button"
                            class="btn btn-primary"><i class="bi bi-filetype-pdf"></i>DOWNLOAD PDF</button></a>
    ...
    <div class="modal fade" id="usahaSalvage" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">D. STANDAR USAHA SALVAGE DAN ATAU PEKERJAAN BAWAH AIR
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <dl class="row" style="color: darkslategray;">
                        ...
                        <dd class="col-sm-9">
                            ...
                            <ol type="a">
                                ...
                                <li style="margin-bottom: 0%">memiliki 1 (satu) orang tenaga ahli berkewarganegaraan
                                    Indonesia yang memiliki kemampuan merencanakan dan melaksanakan salvage dan/ atau
                                    pekerjaan bawah air;</li>
                                <li style="margin-bottom: 0%">memiliki paling sedikit 1 (satu) tim penyelam yang terdiri
                                ...
                                <li style="margin-bottom: 0%">Memiliki 4 (empat) set alat selam Self Contained Underwater
                                    Breathing Apparatus (SCUBA) atau 1 (satu) set alat selam Surface Supplied Breathing
                                    Apparatus (SSBA);</li>
                                <li style="margin-bottom: 0%">Untuk kegiatan salvage memiliki paling sedikit 1 (satu) unit
                                    kapal kerja jenis crane barge atau tug boat berbendera Indonesia; dan</li>
                                <li style="margin-bottom: 0%">untuk kegiatan pekerjaan bawah air memiliki paling sedikit 1
                    ...
                    <a href="dokumen/PERIZINAN STANDAR USAHA SALVAGE.pdf"><button type="button"
                            class="btn btn-primary"><i class="bi bi-filetype-pdf"></i>DOWNLOAD PDF</button></a>
