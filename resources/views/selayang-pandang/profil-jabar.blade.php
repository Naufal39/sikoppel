    ...
    <div class="container">
        <div class="row">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#topografi" type="button" role="tab" aria-controls="profile" aria-selected="false">Topografi</button>
                </li>
                <li class="nav-item" role="presentation">
              ...
              <div class="tab-content fs-5 text-dark" id="myTabContent" style="text-align: justify">
                  <div class="tab-pane fade show active" id="luasdanbataswilayah" role="tabpanel" aria-labelledby="home-tab" style="">
                    <center>
                        <img src="{{ asset('img/peta-jawa-barat.jpg') }}" alt="" class="mt-3" style="max-width: 50%;">
                        <p style="font-size: 11px;">src: https://www.lamudi.co.id/journal/peta-jawa-barat/</p>
                    </center>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;text-indent:18.0pt;'>Secara Geografis Provinsi Jawa Barat terletak pada posisi 104&deg;48&quot; - 108&deg;48&quot; Bujur Timur dan 5&deg;50&quot; - 7&deg;50&quot; Lintang Selatan, dengan batasbatas wilayah sebagai berikut:</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>a. Sebelah Utara : berbatasan dengan Laut Jawa dan Provinsi DKI Jakarta</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>b. Sebelah Barat : berbatasan dengan Provinsi Banten</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>c. Sebelah Timur : berbatasan dengan Provinsi Jawa Tengah</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>d. Sebelah Selatan : berbatasan dengan Samudera Hindia</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Provinsi Jawa Barat memiliki luas wilayah 37.087.92 Km2 (Sumber: RTRW Provinsi Jawa Barat, perhitungan GIS) dengan garis pantai sepanjang 832,69 km (Sumber: Peta RZWP3K Provinsi Jawa Barat). Berdasarkan kewenangan pengelolaan laut 0-12 mil, luas wilayah laut Provinsi Jawa Barat adalah 1.552.890,67 Ha, dan memiliki jumlah pulaupulau kecil 19 buah.</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>&nbsp;</p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:18.0pt;font-family:"Calibri",sans-serif;text-align:justify;'>&nbsp; &nbsp; &nbsp; &nbsp; Secara administratif, wilayah Provinsi Jawa Barat terbagi kedalam 27 kabupaten/kota, meliputi 18 kabupaten dan 9 Kota, yaitu Kabupaten Bogor, Sukabumi, Cianjur, Bandung, Bandung Barat, Garut, Tasikmalaya, Ciamis, Kuningan, Cirebon, Majalengka, Sumedang, Indramayu, Subang, Purwakarta, Karawang, Bekasi, dan Pangandaran serta Kota Bogor, Sukabumi, Bandung, Cirebon, Bekasi, Depok, Cimahi, Tasikmalaya dan Kota Banjar. Kabupaten Sukabumi merupakan wilayah kabupaten terluas di Provinsi Jawa Barat dengan luas 4.145,70 Km2 (11,72 persen terhadap luas wilayah Provinsi Jawa Barat), sedangkan wilayah terkecil adalah Kota Cirebon yaitu seluas 37,36 Km2 (0,11 persen terhadap luas wilayah Provinsi Jawa Barat).</p>
                </div>
                <div class="tab-pane fade" id="topografi" role="tabpanel" aria-labelledby="profile-tab">
                    <p>Jawa Barat terdiri atas wilayah pegunungan curam di selatan, wilayah lereng bukit yang landai di tengah, wilayah dataran luas di utara, dan wilayah aliran sungai. Wilayah pegunungan curam (9,5%) terletak di bagian selatan dengan ketinggian lebih dari 1.500 m di atas permukaan laut, dan wilayah lereng bukit yang landai (36,48%) terletak di bagian tengah dengan ketinggian 10-1.500 m dpl, serta wilayah daratan landai (54,02%) terletak di bagian utara dengan ketinggian 0-10 mdpl. Kondisi fisik dasar pesisir utara Jawa Barat yang terdiri atas dataran pantai dan rawa alluvial pantai dengan kemiringan lereng 0%–5%, merupakan daerah yang bertopografi landai, perairan dangkal, memiliki substrat lumpur, berpasir dan berawa, pola arus yang dipengaruhi arus laut Jawa, serta
                        bervegetasi mangrove dan terumbu karang. Topografi Wilayah Pansela Jawa Barat merupakan pegunungan dan perbukitan terjal, perairan dalam dengan banyak batu karang dan pantai berpasir, pola arus laut yang kuat yang dipengaruhi keberadaan Samudera Indonesia.
                        </p>
                </div>
