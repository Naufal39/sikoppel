        ...
        <div class="row">
          <center>
            ...
            <ul class="nav nav-tabs d-flex justify-content-center" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#fungsi" type="button" role="tab" aria-controls="profile" aria-selected="false">Fungsi</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#kewenangan" type="button" role="tab" aria-controls="contact" aria-selected="false">Kewenangan</button>
                </li>
              </ul>
              
              <div class="tab-content fs-5 text-dark" id="myTabContent" style="text-align: justify">
                  <div class="tab-pane fade show active" id="tugaspokok" role="tabpanel" aria-labelledby="home-tab" style="">
                ...
                <div class="tab-pane fade" id="fungsi" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <ul>
                    <li>penyelenggaraan perumusn kebgakan teknis di bidang perhubungan, yang menjadi kewenangan Provinsi;</li>
                    <li>penyelenggaraan kebijakan teknis di bidang perhubungan, yang menjadikewenangan Provinsi;</li>
